...
class TestChatCompletion:
    ...
    def test_chat_completion_with_normal(self):
        ...
        for normal_chat_completion_data in normal_chat_completion_data_list:
            normal_res = chat_completion(**normal_chat_completion_data)
    ...
    @pytest.mark.run(order=1)
    def test_chat_completion_with_multi_round(self):
        ...
        for multi_round_data in multi_round_data_list:
            multi_round_res = chat_completion(**multi_round_data)
    ...
    def test_chat_completion_with_max_tokens(self):
        ...
        for max_tokens_data in max_tokens_data_list:
            max_tokens_res = chat_completion(**max_tokens_data)
    ...
    @pytest.mark.run(order=1)
    def test_chat_completion_with_stream(self):
        ...
        for stream_data in stream_data_list:
            stream_res = chat_completion(**stream_data)
...
class TestTextEmbedding:
    ...
    def test_text_embedding_with_str(self):
    ...
    @pytest.mark.run(order=0)
    def test_text_embedding_with_str_list(self):
