...
class TestMessage(Base):
    ...
    def test_clean_chat_context(self, assistant_id, chat_id):
        # Generate an assistant message by no stream.

        res = clean_chat_context(assistant_id=assistant_id, chat_id=chat_id)
        res_dict = vars(res)
    ...
    def test_assistant_by_user_message_retrieval_and_stream(self):
        # Create an assistant.
    ...
    @pytest.mark.run(order=70)
    def test_assistant_by_memory_retrieval_and_stream(self):
        # Create an assistant.
    ...
    @pytest.mark.run(order=70)
    def test_assistant_by_function_call_retrieval_and_stream(self):
        # Create an assistant.
    ...
    @pytest.mark.run(order=70)
    def test_assistant_by_not_support_function_call_retrieval_and_stream(self):
        # Create an assistant.
    ...
    @pytest.mark.run(order=70)
    def test_assistant_by_all_tool_and_stream(self):
        # Create an assistant.
    ...
    @pytest.mark.run(order=70)
    def test_assistant_by_not_support_function_call_tool_and_stream(self):
        # Create an assistant.
