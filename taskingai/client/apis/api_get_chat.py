...
__all__ = ["api_get_chat", "async_api_get_chat"]


def api_get_chat(assistant_id: str, chat_id: str, **kwargs) -> ChatGetResponse:
    # get api client
...
async def async_api_get_chat(assistant_id: str, chat_id: str, **kwargs) -> ChatGetResponse:
    # get api client
