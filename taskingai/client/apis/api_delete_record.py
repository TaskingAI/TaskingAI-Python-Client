...
__all__ = ["api_delete_record", "async_api_delete_record"]


def api_delete_record(collection_id: str, record_id: str, **kwargs) -> BaseEmptyResponse:
    # get api client
...
async def async_api_delete_record(collection_id: str, record_id: str, **kwargs) -> BaseEmptyResponse:
    # get api client
