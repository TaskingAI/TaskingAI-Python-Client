...
# api_query_collection_chunks.py
...
from ..models import ChunkQueryRequest, ChunkQueryResponse

__all__ = ["api_query_collection_chunks", "async_api_query_collection_chunks"]


def api_query_collection_chunks(collection_id: str, payload: ChunkQueryRequest, **kwargs) -> ChunkQueryResponse:
    # get api client
    ...
    return sync_api_client.call_api(
        resource_path="/v1/collections/{collection_id}/chunks/query",
        method="POST",
        ...
        post_params=[],
        files=files_dict,
        response_type=ChunkQueryResponse,
        auth_settings=[],
...
async def async_api_query_collection_chunks(
    collection_id: str, payload: ChunkQueryRequest, **kwargs
) -> ChunkQueryResponse:
    # get api client
