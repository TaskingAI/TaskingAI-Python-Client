...
def api_update_chat(assistant_id: str, chat_id: str, payload: ChatUpdateRequest, **kwargs) -> ChatUpdateResponse:
    # get api client
...
async def async_api_update_chat(
    assistant_id: str, chat_id: str, payload: ChatUpdateRequest, **kwargs
) -> ChatUpdateResponse:
    # get api client
