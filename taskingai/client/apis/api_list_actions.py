...
def api_list_actions(payload: ActionListRequest, **kwargs) -> ActionListResponse:
    # get api client
...
async def async_api_list_actions(payload: ActionListRequest, **kwargs) -> ActionListResponse:
    # get api client
