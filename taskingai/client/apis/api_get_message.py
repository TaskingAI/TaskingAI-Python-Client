...
def api_get_message(assistant_id: str, chat_id: str, message_id: str, **kwargs) -> MessageGetResponse:
    # get api client
...
async def async_api_get_message(assistant_id: str, chat_id: str, message_id: str, **kwargs) -> MessageGetResponse:
    # get api client
