...
__all__ = ["api_delete_collection", "async_api_delete_collection"]


def api_delete_collection(collection_id: str, **kwargs) -> BaseEmptyResponse:
    # get api client
...
async def async_api_delete_collection(collection_id: str, **kwargs) -> BaseEmptyResponse:
    # get api client
