...
def api_list_assistants(payload: AssistantListRequest, **kwargs) -> AssistantListResponse:
    # get api client
...
async def async_api_list_assistants(payload: AssistantListRequest, **kwargs) -> AssistantListResponse:
    # get api client
