...
def api_get_record(collection_id: str, record_id: str, **kwargs) -> RecordGetResponse:
    # get api client
...
async def async_api_get_record(collection_id: str, record_id: str, **kwargs) -> RecordGetResponse:
    # get api client
