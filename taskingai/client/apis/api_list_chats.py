...
from ..models import ChatListRequest, ChatListResponse

__all__ = ["api_list_chats", "async_api_list_chats"]


def api_list_chats(assistant_id: str, payload: ChatListRequest, **kwargs) -> ChatListResponse:
    # get api client
    ...
    return sync_api_client.call_api(
        resource_path="/v1/assistants/{assistant_id}/chats",
        method="GET",
        ...
        post_params=[],
        files=files_dict,
        response_type=ChatListResponse,
        auth_settings=[],
...
async def async_api_list_chats(assistant_id: str, payload: ChatListRequest, **kwargs) -> ChatListResponse:
    # get api client
