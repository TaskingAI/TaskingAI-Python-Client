...
class RetrievalApi(object):
    ...
    def create_collection(self, body, **kwargs):  # noqa: E501
        ...
        :param CollectionCreateRequestBodySchema body: (required)
        :return: CollectionCreateResponseSchema
    ...
    def create_collection_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='CollectionCreateResponseSchema',  # noqa: E501
    ...
    def create_record(self, body, collection_id, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param RecordCreateRequestBodySchema body: (required)
        :param object collection_id: (required)
        :return: RecordCreateResponseSchema
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
    ...
    def create_record_with_http_info(self, body, collection_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/v1/collections/{collection_id}/records', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='RecordCreateResponseSchema',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def delete_record_with_http_info(self, collection_id, record_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/v1/collections/{collection_id}/records/{record_id}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_collection(self, collection_id, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param object collection_id: (required)
        :return: CollectionGetResponseSchema
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
    ...
    def get_collection_with_http_info(self, collection_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='CollectionGetResponseSchema',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_record(self, collection_id, record_id, **kwargs):  # noqa: E501
        ...
        :param object collection_id: (required)
        :param object record_id: (required)
        :return: RecordGetResponseSchema
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
    ...
    def get_record_with_http_info(self, collection_id, record_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/v1/collections/{collection_id}/records/{record_id}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='RecordGetResponseSchema',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def list_collections(self, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :return: CollectionListResponseSchema
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
    ...
    def list_collections_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='CollectionListResponseSchema',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def list_records_with_http_info(self, collection_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/v1/collections/{collection_id}/records', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='RecordListResponseSchema',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def query_chunks(self, body, collection_id, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param ChunkQueryRequestBodySchema body: (required)
        :param object collection_id: (required)
        :return: ChunkQueryResponseSchema
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
    ...
    def query_chunks_with_http_info(self, body, collection_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/v1/collections/{collection_id}/chunks/params', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='ChunkQueryResponseSchema',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def update_collection(self, body, collection_id, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param CollectionUpdateRequestBodySchema body: (required)
        :param object collection_id: (required)
        :return: CollectionUpdateResponseSchema
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
    ...
    def update_collection_with_http_info(self, body, collection_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/v1/collections/{collection_id}', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='CollectionUpdateResponseSchema',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def update_record(self, body, collection_id, record_id, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param RecordUpdateRequestBodySchema body: (required)
        :param object collection_id: (required)
        :param object record_id: (required)
        :return: RecordUpdateResponseSchema
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
    ...
    def update_record_with_http_info(self, body, collection_id, record_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/v1/collections/{collection_id}/records/{record_id}', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='RecordUpdateResponseSchema',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
